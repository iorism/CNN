...
%%% mex gateway source
mex_src = {} ; 
mex_src{end+1} = fullfile('./temp3.cu');
%%% lib source
lib_src = {} ; 
% common
lib_src{end+1} = fullfile('./../src/Timer.cpp') ;
lib_src{end+1} = fullfile('./../src/wrapperBlas_cpu.cpp') ;
if opts.enableGpu % GPU-specific files
  lib_src{end+1} = fullfile('./../src/wrapperBlas_gpu.cu') ;
end
